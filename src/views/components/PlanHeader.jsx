        ...
        >
          {plan.badge && (
            <div className="absolute -top-10 left-0 right-0 flex justify-center">
              <span className="bg-[#21B3E6] text-white text-xs font-medium tracking-[0.7px] rounded-full uppercase py-[10px] px-[24px]">
                Most Popular
              </span>
            </div>
          )}

          <h1 className="font-Roboto text-2xl lg:text-3xl font-semibold tracking-tight items-center text-[#162945] ">
            {plan.title}
          </h1>
          <p className="font-Roboto text-base leading-relaxed items-center text-[#162945]">
            {plan.description}
          </p>
