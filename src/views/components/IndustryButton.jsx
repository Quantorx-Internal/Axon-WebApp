...
function IndustryButton() {
    return (
        <button className="flex flex-row sm:flex-row items-center justify-between bg-[#036FE2] text-white rounded-[36.83px] w-full px-2 sm:px-8 py-2 sm:py-[9px] gap- sm:gap-0">
